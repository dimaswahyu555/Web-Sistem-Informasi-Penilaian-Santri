                                ...
                                <?php if ($result && mysqli_num_rows($result) > 0): ?>
                                    ...
                                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php
                                                // Tampilkan gambar profile jika ada, jika tidak tampilkan default
                                                $foto = $row['foto'];
                                                $foto_path = "../image/" . $foto;
                                                if (!empty($foto) && file_exists($foto_path)) {
                                                    echo "<img src=\"$foto_path\" alt=\"Foto Santri\" width=\"60\" class=\"rounded-circle shadow-sm\">";
                                                } else {
                                                    echo "<img src=\"../image/default.png\" alt=\"Foto Default\" width=\"60\" class=\"rounded-circle shadow-sm\">";
                                                }
                                                ?>
                                            </td>
                                            <td>
